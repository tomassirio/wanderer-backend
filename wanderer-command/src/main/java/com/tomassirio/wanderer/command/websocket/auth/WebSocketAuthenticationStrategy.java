 ...
 * 
 * <p>Implementations of this interface define different authentication strategies
 * for WebSocket connections (e.g., authenticated users, anonymous guests).
 */
public interface WebSocketAuthenticationStrategy {
     ...
     * @return an AuthenticationResult containing the userId (null for anonymous) and authentication status
     */
