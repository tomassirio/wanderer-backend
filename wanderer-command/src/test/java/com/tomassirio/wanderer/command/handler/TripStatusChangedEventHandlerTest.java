...
class TripStatusChangedEventHandlerTest {
    ...
    void handle_whenTripExists_shouldUpdateTripStatus() {
        ...
        // Lifecycle updates are now sent from frontend with GPS data, not auto-generated by backend
    ...
    void handle_whenTripExists_shouldDelegateToLifecycleTripUpdateManager() {
        ...
        // Instead, verify that other managers are still called
        verify(tripDayManager).manageTripDays(trip, TripStatus.IN_PROGRESS, TripStatus.RESTING);
    }
